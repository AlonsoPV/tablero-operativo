-- =============================================================================
-- CONSOLIDADO: migraciones del repo en orden (ejecución manual en SQL Editor).
--
-- IMPORTANTE
-- - Pensado para base NUEVA / vacía (public sin tablas de la app). Si ya tenés
--   esquema, NO ejecutes todo: usá migraciones incrementales o supabase db push.
-- - Requiere extensión uuid-ossp (la crea initial_schema).
