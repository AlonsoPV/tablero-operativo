-- =============================================================================
-- Duplica la acción UAT-03 | Validación Notificaciones para 3 responsables.
--
-- Origen : 09a4a722-cb84-4db4-81fd-82aa4d208f3f
...
-- 0) Diagnóstico: revisa cómo se resuelven los IDs antes de duplicar.
SELECT
  ref.user_ref,
  u.id AS usuarios_id,
...
DO $$
DECLARE
  v_source_id uuid := '09a4a722-cb84-4db4-81fd-82aa4d208f3f';
...
WHERE a.titulo_accion = 'UAT-03 | Validación Notificaciones'
  AND (
    u.id IN (
      'b96a7dee-5ace-4d33-8ce5-a5be27cc2630'::uuid,
      'f3b57fa8-9d7d-42f1-8da0-4d8c22ea420e'::uuid,
