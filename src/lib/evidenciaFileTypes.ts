...
export const EVIDENCIA_ACCEPTED_FORMATS_LABEL = 'PDF, PNG, JPG, JPEG, WEBP, CSV o Excel (max. 10 MB)'

export const EVIDENCIA_ACCEPTED_FORMATS_SHORT = 'PDF, PNG, JPG, JPEG, WEBP, CSV o Excel'
