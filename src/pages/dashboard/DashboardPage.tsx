              ...
              <SectionCardHeader
                ...
                action={
                  <div className="flex w-full flex-wrap items-center justify-end gap-2 sm:w-auto">
                    <InfoHint text="Las cinco acciones abiertas con story points y mayor impacto estimado (peso del KPI y puntos del gap). Si no hay brecha vinculada, se ordenan por puntos." />
                ...
                {impactMatrixLoading || gapLinksLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border/60 bg-muted/5 px-6 py-12 text-center">
                    ...
                    <p className="mt-1.5 max-w-md text-sm leading-relaxed text-muted-foreground">
                      No hay acciones abiertas con story points. Asigna puntos en el Kanban y vincula brechas para
                      ver impacto sobre KPIs.
                    </p>
