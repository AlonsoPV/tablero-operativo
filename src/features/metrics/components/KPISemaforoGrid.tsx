...
export function KPISemaforoGrid({ fecha }: KPISemaforoGridProps) {
  ...
  if (!items.length) {
    return (
      <div className="flex min-h-[120px] flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border/60 bg-muted/10 py-8 text-center">
